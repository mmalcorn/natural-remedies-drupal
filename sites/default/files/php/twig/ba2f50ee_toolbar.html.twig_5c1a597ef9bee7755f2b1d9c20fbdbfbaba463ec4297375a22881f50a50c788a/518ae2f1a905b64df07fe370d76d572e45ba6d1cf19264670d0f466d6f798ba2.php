...
class __TwigTemplate_9f977dc72a059386d8bb3a511231c9f6faec67fa1b6dbd97e18317ec95d3caef extends Twig_Template
{
  ...
  ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["tray"]) {
            ...
            // line 32
            echo "    <div";
            echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute($context["tray"], "attributes", array()), "html", null, true));
            echo ">
    ";
            // line 33
            if ($this->getAttribute($context["tray"], "label", array())) {
                ...
                echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute($context["tray"], "label", array()), "html", null, true));
                echo "\">
    ...
    ";
            ...
            // line 39
            echo "        ";
            echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute($context["tray"], "links", array()), "html", null, true));
            echo "
      </nav>
    </div>
    ";
