...
class __TwigTemplate_4409df241ee0a38b80acbbdaee5e6d50ea89aade9d9caef4aae5ae5534f1645e extends Twig_Template
{
...
(isset($context["logged_in"]) ? $context["logged_in"] : null)) ? ("user-logged-in") : ("user-anonymous")), 1 => (( !        // line 33
(isset($context["root_path"]) ? $context["root_path"] : null)) ? ("path-frontpage") : (("path-innerpage not-front path-" . \Drupal\Component\Utility\Html::getClass((isset($context["root_path"]) ? $context["root_path"] : null))))), 2 => ((        // line 34
...
(isset($context["db_offline"]) ? $context["db_offline"] : null)) ? ("db-offline") : ("")), 4 =>         // line 36
(isset($context["navbar_position"]) ? $context["navbar_position"] : null));
        // line 39
        echo "<!DOCTYPE html>
<html";
        // line 40
